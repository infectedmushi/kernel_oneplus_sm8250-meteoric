#!/bin/bash
#### UNIFIED BUILDS ####
export KERNEL_DIR="/mnt/Android/hellboy_sd8250_oos"
export KBUILD_OUTPUT="/mnt/Android/hellboy_sd8250_oos/out"
...
export ARCH=arm64
export VARIANT="aurora-hell-r10"
