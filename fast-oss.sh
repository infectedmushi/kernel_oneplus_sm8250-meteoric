#!/bin/bash
#### UNIFIED BUILDS ####
export KERNEL_DIR="/mnt/Android/hellboy_sm8250"
export KBUILD_OUTPUT="/mnt/Android/hellboy_sm8250/out"
...
#make O=out mrproper
#rm -rfv out
export PATH="/mnt/Bathtube/toolchains/neutron-clang/bin:$PATH"
export USE_CCACHE=1
export CLANG_PATH="/mnt/Bathtube/toolchains/neutron-clang/bin/clang"
export ARCH=arm64
export VARIANT="aurora-hell-r05"
...
make $KBUILD_OUTPUT CC=clang LLVM=1 LLVM_IAS=1 vendor/kona-perf_defconfig
make $KBUILD_OUTPUT CC=clang AR=llvm-ar NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip LLVM=1 LLVM_IAS=1 -j32 CROSS_COMPILE=/mnt/Bathtube/toolchains/gcc-linaro-12.2.1-2023.03-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu- CROSS_COMPILE_ARM32=/mnt/Bathtube/toolchains/gcc-linaro-12.2.1-2023.03-aarch64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-
